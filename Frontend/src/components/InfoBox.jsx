...
const InfoBox = ({ product }) => (
    <div className="flex justify-between gap-3 w-full ">
        <div className="bg-info-box flex flex-col justify-between items-center w-1/4 px-6 py-2 rounded-xl gap-2 max-md:px-2">
        ...
        <div className="bg-info-box flex flex-col justify-between items-center w-1/4 px-6 py-2 rounded-xl gap-2 max-md:px-2 max-md:text-xs">
            <h2 className="">ER</h2>
            <p className="text-white text-sm bg-blue px-1 py-[2px] rounded-sm flex justify-center items-center max-md:text-xs">
