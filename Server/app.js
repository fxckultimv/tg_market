...
app.use('/api/product_stats', authMiddleware, productStatsRouter)
app.use('/api/cart', authMiddleware, cartRouter)
app.use('/api/orders', authMiddleware, ordersRouter)
app.use('/api/history', authMiddleware, historyRouter)
app.use('/api/check_admin', authMiddleware, checkAdminRouter)
app.use('/api/admin_stats', authMiddleware, adminStatsRouter)
